...
import { Activities, Books, Authers, Users } from "./Pages";
			...
			<BrowserRouter>
				<div className="flex relative dark:bg-main-dark-bg">
					...
					>
						<OverlayTrigger
							placement="left"
							overlay={<Tooltip style={{padding:"6px", background:"grey", color:"white", marginRight:"5px", borderRadius:"5px"}}>Settings</Tooltip>}
						>
							<button
								type="button"
